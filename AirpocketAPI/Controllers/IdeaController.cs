                ...
                foreach (var rec in ideaRecords)
                {
                    if (rec.CrewId != null)
                    {
                        if (rec.CourseType == "CRM")
                        {
                            ...
                            if (person != null && rec.DateExpire > person.UpsetRecoveryTrainingExpireDate)
                            {
                        ...
                        {
                            var person = people.FirstOrDefault(q => q.NID == rec.NID);
                            if (person != null && rec.DateExpire > person.CCRMExpireDate)
                            {
                        ...
                        {
                            var person = people.FirstOrDefault(q => q.NID == rec.NID);
                            if (person != null && rec.DateExpire > person.SMSExpireDate)
                            {
                        ...
                        {
                            var person = people.FirstOrDefault(q => q.NID == rec.NID);
                            if (person != null && rec.DateExpire > person.FirstAidExpireDate)
                            {
                        ...
                        {
                            var person = people.FirstOrDefault(q => q.NID == rec.NID);
                            if (person != null && rec.DateExpire > person.HotWeatherOperationExpireDate)
                            {
                        ...
                        {
                            var person = people.FirstOrDefault(q => q.NID == rec.NID);
                            if (person != null && rec.DateExpire > person.ColdWeatherOperationExpireDate)
                            {
                        ...
                        {
                            var person = people.FirstOrDefault(q => q.NID == rec.NID);
                            if (person != null && rec.DateExpire > person.SEPTPExpireDate)
                            {
                        ...
                        {
                            var person = people.FirstOrDefault(q => q.NID == rec.NID);
                            if (person != null && rec.DateExpire > person.AviationSecurityExpireDate)
                            {
                        ...
                        {
                            var person = people.FirstOrDefault(q => q.NID == rec.NID);
                            if (person != null && rec.DateExpire > person.DangerousGoodsExpireDate)
                            {
                        ...
                        {
                            var person = people.FirstOrDefault(q => q.NID == rec.NID);
                            if (person != null && rec.DateExpire > person.RecurrentExpireDate)
                            {
