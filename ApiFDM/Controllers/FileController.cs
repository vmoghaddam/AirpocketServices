        ...
        public async Task<List<FailedItmes>> boeingImport(string fn)
        {
            ...
            try
            {
                ...
                for (int i = 1; i < rows.Count(); i++)
                {
                    ...
                    flight.P1 = row[12];
                    flight.P2 = row[13];
                    flight.Aircraft = row[14];
                    flight.FlightPhase = row[15];
                    flight.StateName = row[16];
                    flight.Context = row[17];
                    flight.TORunway = row[18];
                    flight.TDRunway = row[19];
                    flight.TODatetime = row[20];
                    flight.Type = row[21];
                    flight.Units = row[22];
                    flight.ValueName = row[23];
                    flight.EnginePos = row[24];
